...
/**
 * Specifies a web service that supports the rssCloud interface which can be implemented in HTTP-POST, XML-RPC or SOAP
 * 1.1. Its purpose is to allow processes to register with a cloud to be notified of updates to the channel,
...
public class TCloud {
     ...
     *
     * @return possible object is {@link TCloudProtocol }
     */
     ...
     *
     * @param value allowed object is {@link TCloudProtocol }
     */
